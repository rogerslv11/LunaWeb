...
import FormularioSolicitacao from "./components/Forms";
...
export default function App() {
  ...
  return (
    ...
    <main  className="absolute top-0 z-[-2]  w-screen bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#000_1px)] bg-[size:20px_20px]">
      ...
      <section className=" px-16 pt-40 pb-10 grid gap-5 place-items-center">
        <h2 className="  capitalize text-white   text-center font-semibold text-6xl" >
        ...
        <a className=" bg-lime-400 text-2xl p-2 rounded-xl font-semibold" href="">Agende uma conversa</a>

      </section>
      <section className=" pt-10 grid gap-5">
        <h2 className=" text-4xl text-center text-white font-semibold ">Por que escolher a <span className=" text-lime-400">LunaDev</span></h2>
        <p className=" text-center  text-2xl text-white font-semibold">Três vantagens claras que unimos em cada projeto: propósito, técnica e estratégia.</p>
        <Advantages/>
      </section>
      ...
      <div className=" w-full px-20 mx-auto px-6 flex flex-col lg:flex-row items-center gap-12">
        
        {/* Texto */}
        <div className="lg:w-2/3 text-white text-2xl">
          <h2 className="text-5xl font-bold mb-6">Sobre a LunaDev</h2>
    ...
    <section className=" grid gap-6 mb-14">
      <p className=" text-xl text-center font-semibold uppercase  text-lime-400">Entre em Contato</p>
      <h3 className="  text-center text-white text-4xl font-semibold ">Solicite Seu Orçamento Gratuito</h3>
      <p className=" text-center text-white text-2xl">Preencha o formulário abaixo e nossa equipe entrará em  contato<br/> em até 24 horas para discutir seu projeto.</p>
      <Forms/>
    </section>
    <section>
      <Footer/>
